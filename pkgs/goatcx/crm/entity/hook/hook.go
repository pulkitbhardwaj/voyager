...
type LeadFunc func(context.Context, *entity.LeadMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f LeadFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	if mv, ok := m.(*entity.LeadMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.LeadMutation", m)
}

// The OrganizationFunc type is an adapter to allow the use of ordinary
// function as Organization mutator.
type OrganizationFunc func(context.Context, *entity.OrganizationMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f OrganizationFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	if mv, ok := m.(*entity.OrganizationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.OrganizationMutation", m)
}
