...
import (
	...
	"github.com/pulkitbhardwaj/voyager/pkgs/goatcx/crm/entity/migrate"
...
func (c *LeadClient) mutate(ctx context.Context, m *LeadMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entity: unknown Lead mutation op: %q", m.Op())
	}
}
...
func (c *OrganizationClient) mutate(ctx context.Context, m *OrganizationMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entity: unknown Organization mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Lead, Organization, User []ent.Hook
	}
	inters struct {
		Lead, Organization, User []ent.Interceptor
	}
)
