...
func (l *LeadQuery) CollectFields(ctx context.Context, satisfies ...string) (*LeadQuery, error) {
...
func (l *LeadQuery) collectField(ctx context.Context, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	return nil
}

type leadPaginateArgs struct {
	first, last   *int
	after, before *Cursor
	opts          []LeadPaginateOption
}

func newLeadPaginateArgs(rv map[string]interface{}) *leadPaginateArgs {
	args := &leadPaginateArgs{}
	if rv == nil {
		return args
	}
